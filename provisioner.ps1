...
#>
param(
   [string]$MsiUrl = "https://downloads.puppetlabs.com/windows/puppet-agent-1.3.2-x64.msi"
...
if (!($PuppetInstalled)) {
  ...
  Add-Content C:\ProgramData\PuppetLabs\puppet\etc\puppet.conf "[agent]`r`nserver=puppet.example.com"
  Add-Content C:\windows\system32\drivers\etc\hosts "192.168.32.5       puppet.example.com"
